...
class BaseEffectModule {
  public:
    ...
    */
    ...
    /** Gets the value of an Effect Parameter as a 0..1 magnitude (inverse of
        SetParameterAsMagnitude). Respects the parameter's value curve.
        \param parameter_id Id of the parameter to retrieve.
        \return the parameter value normalised into 0..1.
    */
    float GetParameterAsMagnitude(int parameter_id) const;
