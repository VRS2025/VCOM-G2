...
#include "st7565.h" // VCOM-G2: драйвер LCD GMG12864-06D (ST7565R)
#include <vector>

using namespace daisy;

/** VCOM-G2: дисплей — LCD GMG12864-06D (ST7565R) вместо OLED SSD1306.
 *  Те же пины 4-wire SPI. Если картинка кривая — крути константы в st7565.h.
 */
using MyOledDisplay = OledDisplay<ST75654WireSpi128x64Driver>;
